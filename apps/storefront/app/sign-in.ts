...
export function signInError(error: unknown): string {
  ...
  const messages: Record<string, string> = {
    'auth/popup-blocked':
      'Please allow the Google sign-in popup and try again.',
    'auth/popup-closed-by-user':
      'Sign-in was closed. Please try again.',
    'auth/invalid-phone-number':
      'Enter a valid 10-digit Indian mobile number.',
    'auth/invalid-verification-code':
      'That code is incorrect. Check your SMS and try again.',
    'auth/code-expired':
      'Your code expired. Request a new one.',
    'auth/too-many-requests':
      'Too many attempts. Please wait before trying again.',
    'auth/quota-exceeded':
      'SMS is temporarily unavailable. Please use Google sign-in.',
    'auth/operation-not-allowed':
      'Sign-in is not enabled yet. Please contact the store.',
    'auth/billing-not-enabled':
      'SMS is not enabled for this store yet. Please use Google sign-in.',
